  ...
  return (
    <section className="features-section">
      <div id="features" className="container-fluid vh-100 pt-5">
          ...
          <div className="individualFeature col-md-6 col-lg-4 p-4 d-flex flex-column justify-content-between">
        ...
        {/* Second Row */}
        <div className="row justify-content-evenly">
          <div className="individualFeature col-md-6 col-lg-4 mb-4 p-4 d-flex flex-column justify-content-between">
            <div className='featureTitle d-flex row align-items-center justify-content-center'>
