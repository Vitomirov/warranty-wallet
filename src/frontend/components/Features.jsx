...
const Features = () => {
  return (
    <section className="features-section">
      <div id="features" className="helpBorder container-fluid min-vh-100">

          {/* First Row */}
          <div className="row d-flex justify-content-evenly pt-5 mt-5">
            <div className=" individualFeature col-md-6 col-lg-4 p-4 d-flex flex-column justify-content-evenly">
              ...
              <div className='featureTitle d-flex row align-items-center justify-content-center'>
                <i className="bi bi-arrow-down-left h3 d-flex justify-content-center"></i>
                <h5 className="text-center">Centralized Warranty Management</h5>
              </div>
            </div>
          <div className="individualFeature col-md-6 col-lg-4 p-4 d-flex flex-column justify-content-evenly">
            <span className="hover-text">
            ...
            <div className='featureTitle d-flex row align-items-center justify-content-center'>
              ...
              <h5 className="text-center">Predefined Email Templates</h5>
            </div>
          </div>
         </div>
